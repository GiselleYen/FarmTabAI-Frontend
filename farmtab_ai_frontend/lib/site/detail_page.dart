        ...
        children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: TColor.primaryColor1.withOpacity(.15),
                    ),
                    child: Icon(
                      Icons.close,
          ...
          Positioned(
            ...
            child: Container(
              ...
              width: size.width,
              decoration: BoxDecoration(
                color: TColor.primaryColor1.withOpacity(.4),
          ...
          children: [
            Container(
              ...
              child: IconButton(onPressed: (){
                ...
                Icons.shopping_cart,
                color: _plantList[widget.plantId].isSelected == true ? Colors.white : TColor.primaryColor1,
              )),
              decoration: BoxDecoration(
                  color: _plantList[widget.plantId].isSelected == true ? TColor.primaryColor1.withOpacity(.5) : Colors.white,
                  borderRadius: BorderRadius.circular(50),
                  boxShadow: [
                    BoxShadow(
                      offset: const Offset(0, 1),
                      blurRadius: 5,
                      color: TColor.primaryColor1.withOpacity(.3),
                    ),
                  ]),
            ),
            const SizedBox(
